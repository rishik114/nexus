  ...
  return (
    <div className="flex h-screen bg-bg text-txt">
      ...
      <main className="flex-1 overflow-y-auto">
        {profile && <Composer onPosted={handlePosted} />}
        <StoryBar />
        ...
        {!loading && !profile && (
          <div className="p-4 text-sm text-txt2 border-b border-border">
            <a href="/login" className="text-accent font-semibold">Log in</a> to post, like, and follow — you can still browse the feed below.
          </div>
        )}
